...
#region Autogenerated code
	public partial class Plug : Atk.Object, Atk.IComponent {
		...
		{
			AtkPlugClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetObjectId = callback;
		...
		{
			GetObjectIdNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetObjectId;
		...
		struct AtkPlugClass {
			public GetObjectIdNativeDelegate GetObjectId;
		}

		static uint class_offset = ((GLib.GType) typeof (Atk.Object)).GetClassSize ();
		static Dictionary<GLib.GType, AtkPlugClass> class_structs;

		static AtkPlugClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, AtkPlugClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				AtkPlugClass class_struct = (AtkPlugClass) Marshal.PtrToStructure (class_ptr, typeof (AtkPlugClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, AtkPlugClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
