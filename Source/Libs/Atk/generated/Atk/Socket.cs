...
#region Autogenerated code
	public partial class Socket : Atk.Object, Atk.IComponent {
		...
		{
			AtkSocketClass class_iface = GetClassStruct (gtype, false);
			class_iface.Embed = callback;
		...
		{
			EmbedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Embed;
		...
		struct AtkSocketClass {
			public EmbedNativeDelegate Embed;
		}

		static uint class_offset = ((GLib.GType) typeof (Atk.Object)).GetClassSize ();
		static Dictionary<GLib.GType, AtkSocketClass> class_structs;

		static AtkSocketClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, AtkSocketClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				AtkSocketClass class_struct = (AtkSocketClass) Marshal.PtrToStructure (class_ptr, typeof (AtkSocketClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, AtkSocketClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
