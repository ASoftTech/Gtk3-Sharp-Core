...
#region Autogenerated code
	public partial class AttrFontFeatures : GLib.Opaque {
		...
		extern static uint pangosharp_pango_attrfontfeatures_get_attr_offset ();

		static uint attr_offset = pangosharp_pango_attrfontfeatures_get_attr_offset ();
		public Pango.Attribute Attr {
			get {
				unsafe {
					IntPtr* raw_ptr = (IntPtr*)(((byte*)Handle) + attr_offset);
