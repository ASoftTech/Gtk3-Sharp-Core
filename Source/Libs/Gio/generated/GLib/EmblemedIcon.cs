...
#region Autogenerated code
	public partial class EmblemedIcon : GLib.Object, GLib.IIcon {
		...
		static Dictionary<GLib.GType, GEmblemedIconClass> class_structs;

		static GEmblemedIconClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GEmblemedIconClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GEmblemedIconClass class_struct = (GEmblemedIconClass) Marshal.PtrToStructure (class_ptr, typeof (GEmblemedIconClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GEmblemedIconClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
