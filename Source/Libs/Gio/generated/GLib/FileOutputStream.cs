...
#region Autogenerated code
	public partial class FileOutputStream : GLib.OutputStream, GLib.ISeekable {
		...
		{
			GFileOutputStreamClass class_iface = GetClassStruct (gtype, false);
		...
		{
			try {
				FileOutputStream __obj = GLib.Object.GetObject (inst, false) as FileOutputStream;
				long __result;
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideTell")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideCanSeek")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideSeek")]
		...
		{
			GFileOutputStreamClass class_iface = GetClassStruct (gtype, false);
			class_iface.CanTruncate = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideCanTruncate")]
		...
		{
			CanTruncateNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).CanTruncate;
			if (unmanaged == null) return false;
		...
		{
			GFileOutputStreamClass class_iface = GetClassStruct (gtype, false);
			class_iface.TruncateFn = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideTruncateFn")]
		...
		{
			TruncateFnNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TruncateFn;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideQueryInfo")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideQueryInfoAsync")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideQueryInfoFinish")]
		...
		[GLib.DefaultSignalHandler(Type=typeof(GLib.FileOutputStream), ConnectionMethod="OverrideGetEtag")]
		...
		{
			GetEtagNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetEtag;
		...
		struct GFileOutputStreamClass {
			...
			public CanTruncateNativeDelegate CanTruncate;
			public TruncateFnNativeDelegate TruncateFn;
			...
			public GetEtagNativeDelegate GetEtag;
			IntPtr GReserved1;
			IntPtr GReserved2;
			IntPtr GReserved3;
			IntPtr GReserved4;
		...
		static Dictionary<GLib.GType, GFileOutputStreamClass> class_structs;

		static GFileOutputStreamClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GFileOutputStreamClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GFileOutputStreamClass class_struct = (GFileOutputStreamClass) Marshal.PtrToStructure (class_ptr, typeof (GFileOutputStreamClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GFileOutputStreamClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
