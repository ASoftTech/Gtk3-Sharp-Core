...
#region Autogenerated code
	public partial class FileIOStream : GLib.IOStream, GLib.ISeekable {
		...
		{
			GFileIOStreamClass class_iface = GetClassStruct (gtype, false);
		...
		static Dictionary<GLib.GType, GFileIOStreamClass> class_structs;

		static GFileIOStreamClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GFileIOStreamClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GFileIOStreamClass class_struct = (GFileIOStreamClass) Marshal.PtrToStructure (class_ptr, typeof (GFileIOStreamClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GFileIOStreamClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
