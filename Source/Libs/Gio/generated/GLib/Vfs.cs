...
#region Autogenerated code
	public partial class Vfs : GLib.Object {
		...
		{
			GVfsClass class_iface = GetClassStruct (gtype, false);
			class_iface.DeserializeIcon = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			DeserializeIconNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).DeserializeIcon;
			if (unmanaged == null) return null;
		...
		struct GVfsClass {
			...
			public DeserializeIconNativeDelegate DeserializeIcon;
			IntPtr GReserved1;
			IntPtr GReserved2;
			IntPtr GReserved3;
			IntPtr GReserved4;
