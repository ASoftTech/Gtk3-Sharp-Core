...
#region Autogenerated code
	public partial class Permission : GLib.Object {
		...
		{
			GPermissionClass class_iface = GetClassStruct (gtype, false);
			class_iface.Acquire = callback;
		...
		{
			AcquireNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Acquire;
		...
		{
			GPermissionClass class_iface = GetClassStruct (gtype, false);
			class_iface.AcquireAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			AcquireAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AcquireAsync;
		...
		{
			GPermissionClass class_iface = GetClassStruct (gtype, false);
			class_iface.AcquireFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			AcquireFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AcquireFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			ReleaseNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).Release;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GPermissionClass class_iface = GetClassStruct (gtype, false);
			class_iface.ReleaseAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ReleaseAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ReleaseAsync;
			if (unmanaged == null) return;
		...
		{
			GPermissionClass class_iface = GetClassStruct (gtype, false);
			class_iface.ReleaseFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ReleaseFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ReleaseFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		struct GPermissionClass {
			public AcquireNativeDelegate Acquire;
			public AcquireAsyncNativeDelegate AcquireAsync;
			public AcquireFinishNativeDelegate AcquireFinish;
			public ReleaseNativeDelegate Release;
			public ReleaseAsyncNativeDelegate ReleaseAsync;
			public ReleaseFinishNativeDelegate ReleaseFinish;
			[MarshalAs (UnmanagedType.ByValArray, SizeConst=16)]
			public IntPtr[] Reserved;
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GPermissionClass> class_structs;

		static GPermissionClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GPermissionClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GPermissionClass class_struct = (GPermissionClass) Marshal.PtrToStructure (class_ptr, typeof (GPermissionClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GPermissionClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
