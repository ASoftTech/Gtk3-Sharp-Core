...
#region Autogenerated code
	public partial class HttpProxy : GLib.Object, GLib.IProxy {
		...
		struct GHttpProxyClass {
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GHttpProxyClass> class_structs;

		static GHttpProxyClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GHttpProxyClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GHttpProxyClass class_struct = (GHttpProxyClass) Marshal.PtrToStructure (class_ptr, typeof (GHttpProxyClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GHttpProxyClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
