...
#region Autogenerated code
	public partial class TlsDatabase : GLib.Object {
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.VerifyChain = callback;
		...
		{
			VerifyChainNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).VerifyChain;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.VerifyChainAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			VerifyChainAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).VerifyChainAsync;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.VerifyChainFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			VerifyChainFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).VerifyChainFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.CreateCertificateHandle = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			CreateCertificateHandleNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).CreateCertificateHandle;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateForHandle = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateForHandleNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateForHandle;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateForHandleAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateForHandleAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateForHandleAsync;
			if (unmanaged == null) return;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateForHandleFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateForHandleFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateForHandleFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateIssuer = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateIssuerNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateIssuer;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateIssuerAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateIssuerAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateIssuerAsync;
			if (unmanaged == null) return;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificateIssuerFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificateIssuerFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificateIssuerFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificatesIssuedBy = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificatesIssuedByNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificatesIssuedBy;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificatesIssuedByAsync = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificatesIssuedByAsyncNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificatesIssuedByAsync;
			if (unmanaged == null) return;
		...
		{
			GTlsDatabaseClass class_iface = GetClassStruct (gtype, false);
			class_iface.LookupCertificatesIssuedByFinish = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			LookupCertificatesIssuedByFinishNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).LookupCertificatesIssuedByFinish;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		struct GTlsDatabaseClass {
			public VerifyChainNativeDelegate VerifyChain;
			public VerifyChainAsyncNativeDelegate VerifyChainAsync;
			public VerifyChainFinishNativeDelegate VerifyChainFinish;
			public CreateCertificateHandleNativeDelegate CreateCertificateHandle;
			public LookupCertificateForHandleNativeDelegate LookupCertificateForHandle;
			public LookupCertificateForHandleAsyncNativeDelegate LookupCertificateForHandleAsync;
			public LookupCertificateForHandleFinishNativeDelegate LookupCertificateForHandleFinish;
			public LookupCertificateIssuerNativeDelegate LookupCertificateIssuer;
			public LookupCertificateIssuerAsyncNativeDelegate LookupCertificateIssuerAsync;
			public LookupCertificateIssuerFinishNativeDelegate LookupCertificateIssuerFinish;
			public LookupCertificatesIssuedByNativeDelegate LookupCertificatesIssuedBy;
			public LookupCertificatesIssuedByAsyncNativeDelegate LookupCertificatesIssuedByAsync;
			public LookupCertificatesIssuedByFinishNativeDelegate LookupCertificatesIssuedByFinish;
			[MarshalAs (UnmanagedType.ByValArray, SizeConst=16)]
			private IntPtr[] Padding;
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GTlsDatabaseClass> class_structs;

		static GTlsDatabaseClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GTlsDatabaseClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GTlsDatabaseClass class_struct = (GTlsDatabaseClass) Marshal.PtrToStructure (class_ptr, typeof (GTlsDatabaseClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GTlsDatabaseClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
