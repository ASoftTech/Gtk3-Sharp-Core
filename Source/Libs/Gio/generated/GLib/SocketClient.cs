...
#region Autogenerated code
	public partial class SocketClient : GLib.Object {
		...
		{
			GSocketClientClass class_iface = GetClassStruct (gtype, false);
		...
		static Dictionary<GLib.GType, GSocketClientClass> class_structs;

		static GSocketClientClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GSocketClientClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GSocketClientClass class_struct = (GSocketClientClass) Marshal.PtrToStructure (class_ptr, typeof (GSocketClientClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GSocketClientClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
