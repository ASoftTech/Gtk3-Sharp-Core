...
#region Autogenerated code
	public partial class FileInfo : GLib.Object {
		...
		static Dictionary<GLib.GType, GFileInfoClass> class_structs;

		static GFileInfoClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GFileInfoClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GFileInfoClass class_struct = (GFileInfoClass) Marshal.PtrToStructure (class_ptr, typeof (GFileInfoClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GFileInfoClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
		...
		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr g_file_info_get_deletion_date(IntPtr raw);
		...
		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr g_file_info_get_symbolic_icon(IntPtr raw);

		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void g_file_info_set_symbolic_icon(IntPtr raw, IntPtr icon);
