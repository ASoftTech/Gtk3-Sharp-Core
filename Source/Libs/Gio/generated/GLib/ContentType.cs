...
#region Autogenerated code
	public partial class ContentType {
		...
		[DllImport("libgio-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool g_content_type_is_mime_type(IntPtr type, IntPtr mime_type);

		public static bool TypeIsMimeType(string type, string mime_type) {
			IntPtr native_type = GLib.Marshaller.StringToPtrGStrdup (type);
			IntPtr native_mime_type = GLib.Marshaller.StringToPtrGStrdup (mime_type);
			bool raw_ret = g_content_type_is_mime_type(native_type, native_mime_type);
			bool ret = raw_ret;
			GLib.Marshaller.Free (native_type);
			GLib.Marshaller.Free (native_mime_type);
			return ret;
