...
#region Autogenerated code
	public partial class Overlay : Gtk.Bin {
		...
		{
			GtkOverlayClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetChildPosition = callback;
		...
		{
			GetChildPositionNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetChildPosition;
		...
		struct GtkOverlayClass {
			public GetChildPositionNativeDelegate GetChildPosition;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkOverlayClass> class_structs;

		static GtkOverlayClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkOverlayClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkOverlayClass class_struct = (GtkOverlayClass) Marshal.PtrToStructure (class_ptr, typeof (GtkOverlayClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkOverlayClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
