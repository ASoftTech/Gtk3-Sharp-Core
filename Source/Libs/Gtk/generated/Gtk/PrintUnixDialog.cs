...
#region Autogenerated code
	public partial class PrintUnixDialog : Gtk.Dialog {
		...
		struct GtkPrintUnixDialogClass {
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkPrintUnixDialogClass> class_structs;

		static GtkPrintUnixDialogClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkPrintUnixDialogClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkPrintUnixDialogClass class_struct = (GtkPrintUnixDialogClass) Marshal.PtrToStructure (class_ptr, typeof (GtkPrintUnixDialogClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkPrintUnixDialogClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
