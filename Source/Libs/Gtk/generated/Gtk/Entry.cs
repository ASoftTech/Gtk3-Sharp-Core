...
#region Autogenerated code
	public partial class Entry : Gtk.Widget, Gtk.IEditable, Gtk.ICellEditable {
		...
		{
			GtkEntryClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetFrameSize = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetFrameSizeNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetFrameSize;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		struct GtkEntryClass {
			...
			public GetFrameSizeNativeDelegate GetFrameSize;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
