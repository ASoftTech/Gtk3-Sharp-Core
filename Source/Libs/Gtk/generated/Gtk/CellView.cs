...
#region Autogenerated code
	public partial class CellView : Gtk.Widget, Gtk.ICellLayout, Gtk.IOrientable {
		...
		static Dictionary<GLib.GType, GtkCellViewClass> class_structs;

		static GtkCellViewClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkCellViewClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkCellViewClass class_struct = (GtkCellViewClass) Marshal.PtrToStructure (class_ptr, typeof (GtkCellViewClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkCellViewClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
