...
#region Autogenerated code
	public partial class Invisible : Gtk.Widget {
		...
		static Dictionary<GLib.GType, GtkInvisibleClass> class_structs;

		static GtkInvisibleClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkInvisibleClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkInvisibleClass class_struct = (GtkInvisibleClass) Marshal.PtrToStructure (class_ptr, typeof (GtkInvisibleClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkInvisibleClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
