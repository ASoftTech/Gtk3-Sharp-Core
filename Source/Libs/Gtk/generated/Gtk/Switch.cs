...
#region Autogenerated code
	public partial class Switch : Gtk.Widget, Gtk.IActionable, Gtk.IActivatable {
		...
		{
			GtkSwitchClass class_iface = GetClassStruct (gtype, false);
		...
		{
			StateSetNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).StateSet;
		...
		struct GtkSwitchClass {
			...
			public StateSetNativeDelegate StateSet;
