...
#region Autogenerated code
	public partial class FontChooserDialog : Gtk.Dialog, Gtk.IFontChooser {
		...
		static Dictionary<GLib.GType, GtkFontChooserDialogClass> class_structs;

		static GtkFontChooserDialogClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkFontChooserDialogClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkFontChooserDialogClass class_struct = (GtkFontChooserDialogClass) Marshal.PtrToStructure (class_ptr, typeof (GtkFontChooserDialogClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkFontChooserDialogClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
