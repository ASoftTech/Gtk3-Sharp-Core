...
#region Autogenerated code
	public partial class RecentChooserWidget : Gtk.Box, Gtk.IRecentChooser {
		...
		static Dictionary<GLib.GType, GtkRecentChooserWidgetClass> class_structs;

		static GtkRecentChooserWidgetClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkRecentChooserWidgetClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkRecentChooserWidgetClass class_struct = (GtkRecentChooserWidgetClass) Marshal.PtrToStructure (class_ptr, typeof (GtkRecentChooserWidgetClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkRecentChooserWidgetClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
		...
		public static new GLib.GType GType { 
			get {
				IntPtr raw_ret = gtk_recent_chooser_widget_get_type();
