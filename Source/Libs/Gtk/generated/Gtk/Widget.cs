...
#region Autogenerated code
	...
	public partial class Widget : GLib.InitiallyUnowned, Atk.IImplementor {
		...
		{
			GtkWidgetClass class_iface = GetClassStruct (gtype, false);
			class_iface.TouchEvent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			TouchEventNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TouchEvent;
			if (unmanaged == null) return false;
		...
		{
			GtkWidgetClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetPreferredHeightAndBaselineForWidth = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetPreferredHeightAndBaselineForWidthNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetPreferredHeightAndBaselineForWidth;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GtkWidgetClass class_iface = GetClassStruct (gtype, false);
			class_iface.AdjustBaselineRequest = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			AdjustBaselineRequestNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AdjustBaselineRequest;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GtkWidgetClass class_iface = GetClassStruct (gtype, false);
			class_iface.AdjustBaselineAllocation = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			AdjustBaselineAllocationNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AdjustBaselineAllocation;
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			GtkWidgetClass class_iface = GetClassStruct (gtype, false);
			class_iface.QueueDrawRegion = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			QueueDrawRegionNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).QueueDrawRegion;
			if (unmanaged == null) return;
		...
		struct GtkWidgetClass {
			...
			public TouchEventNativeDelegate TouchEvent;
			public GetPreferredHeightAndBaselineForWidthNativeDelegate GetPreferredHeightAndBaselineForWidth;
			public AdjustBaselineRequestNativeDelegate AdjustBaselineRequest;
			public AdjustBaselineAllocationNativeDelegate AdjustBaselineAllocation;
			public QueueDrawRegionNativeDelegate QueueDrawRegion;
