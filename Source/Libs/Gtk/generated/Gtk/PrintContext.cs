...
#region Autogenerated code
	public partial class PrintContext : GLib.Object {
		...
		struct GtkPrintContextClass {
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GtkPrintContextClass> class_structs;

		static GtkPrintContextClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkPrintContextClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkPrintContextClass class_struct = (GtkPrintContextClass) Marshal.PtrToStructure (class_ptr, typeof (GtkPrintContextClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkPrintContextClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
