...
#region Autogenerated code
	public partial class TextTag : GLib.Object {
		...
		{
			GtkTextTagClass class_iface = GetClassStruct (gtype, false);
			class_iface.TextEvent = callback;
		...
		{
			TextEventNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TextEvent;
		...
		struct GtkTextTagClass {
			public TextEventNativeDelegate TextEvent;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkTextTagClass> class_structs;

		static GtkTextTagClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTextTagClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTextTagClass class_struct = (GtkTextTagClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTextTagClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTextTagClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
