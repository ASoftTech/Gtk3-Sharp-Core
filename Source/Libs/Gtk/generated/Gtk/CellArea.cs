...
#region Autogenerated code
	public partial class CellArea : GLib.InitiallyUnowned {
		...
		{
			GtkCellAreaClass class_iface = GetClassStruct (gtype, false);
			class_iface.ApplyAttributes = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			ApplyAttributesNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).ApplyAttributes;
			if (unmanaged == null) return;
		...
		struct GtkCellAreaClass {
			...
			public ApplyAttributesNativeDelegate ApplyAttributes;
