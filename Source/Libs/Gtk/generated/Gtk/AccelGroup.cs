...
#region Autogenerated code
	public partial class AccelGroup : GLib.Object {
		...
		{
			GtkAccelGroupClass class_iface = GetClassStruct (gtype, false);
			class_iface.AccelChanged = callback;
		...
		{
			AccelChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AccelChanged;
		...
		struct GtkAccelGroupClass {
			public AccelChangedNativeDelegate AccelChanged;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
			IntPtr GtkReserved4;
		...
		static Dictionary<GLib.GType, GtkAccelGroupClass> class_structs;

		static GtkAccelGroupClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkAccelGroupClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkAccelGroupClass class_struct = (GtkAccelGroupClass) Marshal.PtrToStructure (class_ptr, typeof (GtkAccelGroupClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkAccelGroupClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
