...
#region Autogenerated code
	public partial class ColorChooserDialog : Gtk.Dialog, Gtk.IColorChooser {
		...
		static Dictionary<GLib.GType, GtkColorChooserDialogClass> class_structs;

		static GtkColorChooserDialogClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkColorChooserDialogClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkColorChooserDialogClass class_struct = (GtkColorChooserDialogClass) Marshal.PtrToStructure (class_ptr, typeof (GtkColorChooserDialogClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkColorChooserDialogClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
