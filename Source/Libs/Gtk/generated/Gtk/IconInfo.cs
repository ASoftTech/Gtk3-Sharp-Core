...
#region Autogenerated code
	public partial class IconInfo : GLib.Object {
		...
		static Dictionary<GLib.GType, GtkIconInfoClass> class_structs;

		static GtkIconInfoClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkIconInfoClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkIconInfoClass class_struct = (GtkIconInfoClass) Marshal.PtrToStructure (class_ptr, typeof (GtkIconInfoClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkIconInfoClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
