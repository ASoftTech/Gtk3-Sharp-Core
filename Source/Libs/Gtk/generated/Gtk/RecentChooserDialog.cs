...
#region Autogenerated code
	public partial class RecentChooserDialog : Gtk.Dialog, Gtk.IRecentChooser {
		...
		static Dictionary<GLib.GType, GtkRecentChooserDialogClass> class_structs;

		static GtkRecentChooserDialogClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkRecentChooserDialogClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkRecentChooserDialogClass class_struct = (GtkRecentChooserDialogClass) Marshal.PtrToStructure (class_ptr, typeof (GtkRecentChooserDialogClass));
				if (use_cache)
		...
		public static new GLib.GType GType { 
			get {
				IntPtr raw_ret = gtk_recent_chooser_dialog_get_type();
