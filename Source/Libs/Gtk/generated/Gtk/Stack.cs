...
#region Autogenerated code
	public partial class Stack : Gtk.Container {
		...
		static Dictionary<GLib.GType, GtkStackClass> class_structs;

		static GtkStackClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkStackClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkStackClass class_struct = (GtkStackClass) Marshal.PtrToStructure (class_ptr, typeof (GtkStackClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkStackClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
