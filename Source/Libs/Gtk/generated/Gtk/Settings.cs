...
#region Autogenerated code
	public partial class Settings : GLib.Object, Gtk.IStyleProvider {
		...
		static Dictionary<GLib.GType, GtkSettingsClass> class_structs;

		static GtkSettingsClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkSettingsClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkSettingsClass class_struct = (GtkSettingsClass) Marshal.PtrToStructure (class_ptr, typeof (GtkSettingsClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkSettingsClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
