...
#region Autogenerated code
	public partial class GestureDrag : Gtk.GestureSingle {
		...
		{
			GtkGestureDragClass class_iface = GetClassStruct (gtype, false);
		...
		{
			GtkGestureDragClass class_iface = GetClassStruct (gtype, false);
			class_iface.DragUpdate = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			DragUpdateNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).DragUpdate;
			if (unmanaged == null) return;
		...
		struct GtkGestureDragClass {
			...
			public DragUpdateNativeDelegate DragUpdate;
		...
		static Dictionary<GLib.GType, GtkGestureDragClass> class_structs;

		static GtkGestureDragClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkGestureDragClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkGestureDragClass class_struct = (GtkGestureDragClass) Marshal.PtrToStructure (class_ptr, typeof (GtkGestureDragClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkGestureDragClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
