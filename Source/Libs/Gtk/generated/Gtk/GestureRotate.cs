...
#region Autogenerated code
	public partial class GestureRotate : Gtk.Gesture {
		...
		{
			GtkGestureRotateClass class_iface = GetClassStruct (gtype, false);
			class_iface.AngleChanged = callback;
		...
		{
			AngleChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).AngleChanged;
		...
		struct GtkGestureRotateClass {
			public AngleChangedNativeDelegate AngleChanged;
			[MarshalAs (UnmanagedType.ByValArray, SizeConst=10)]
			private IntPtr[] Padding;
		}

		static uint class_offset = ((GLib.GType) typeof (Gtk.Gesture)).GetClassSize ();
		static Dictionary<GLib.GType, GtkGestureRotateClass> class_structs;

		static GtkGestureRotateClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkGestureRotateClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkGestureRotateClass class_struct = (GtkGestureRotateClass) Marshal.PtrToStructure (class_ptr, typeof (GtkGestureRotateClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkGestureRotateClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
