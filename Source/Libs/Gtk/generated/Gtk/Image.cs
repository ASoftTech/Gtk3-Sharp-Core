...
#region Autogenerated code
	public partial class Image : Gtk.Misc {
		...
		static Dictionary<GLib.GType, GtkImageClass> class_structs;

		static GtkImageClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkImageClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkImageClass class_struct = (GtkImageClass) Marshal.PtrToStructure (class_ptr, typeof (GtkImageClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkImageClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
