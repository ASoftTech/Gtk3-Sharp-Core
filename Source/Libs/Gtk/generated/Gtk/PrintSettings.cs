...
#region Autogenerated code
	public partial class PrintSettings : GLib.Object {
		...
		struct GtkPrintSettingsClass {
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GtkPrintSettingsClass> class_structs;

		static GtkPrintSettingsClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkPrintSettingsClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkPrintSettingsClass class_struct = (GtkPrintSettingsClass) Marshal.PtrToStructure (class_ptr, typeof (GtkPrintSettingsClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkPrintSettingsClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
