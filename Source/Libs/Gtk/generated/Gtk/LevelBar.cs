...
#region Autogenerated code
	public partial class LevelBar : Gtk.Widget, Gtk.IOrientable {
		...
		{
			GtkLevelBarClass class_iface = GetClassStruct (gtype, false);
			class_iface.OffsetChanged = callback;
		...
		{
			OffsetChangedNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).OffsetChanged;
		...
		struct GtkLevelBarClass {
			public OffsetChangedNativeDelegate OffsetChanged;
			[MarshalAs (UnmanagedType.ByValArray, SizeConst=16)]
			private IntPtr[] Padding;
		}

		static uint class_offset = ((GLib.GType) typeof (Gtk.Widget)).GetClassSize ();
		static Dictionary<GLib.GType, GtkLevelBarClass> class_structs;

		static GtkLevelBarClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkLevelBarClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkLevelBarClass class_struct = (GtkLevelBarClass) Marshal.PtrToStructure (class_ptr, typeof (GtkLevelBarClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkLevelBarClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
