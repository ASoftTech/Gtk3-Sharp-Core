...
#region Autogenerated code
	public partial class TreeMenu : Gtk.Menu, Gtk.ICellLayout {
		...
		static Dictionary<GLib.GType, GtkTreeMenuClass> class_structs;

		static GtkTreeMenuClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeMenuClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeMenuClass class_struct = (GtkTreeMenuClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeMenuClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeMenuClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
