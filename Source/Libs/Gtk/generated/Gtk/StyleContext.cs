...
#region Autogenerated code
	public partial class StyleContext : GLib.Object {
		...
		{
			GtkStyleContextClass class_iface = GetClassStruct (gtype, false);
		...
		static Dictionary<GLib.GType, GtkStyleContextClass> class_structs;

		static GtkStyleContextClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkStyleContextClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkStyleContextClass class_struct = (GtkStyleContextClass) Marshal.PtrToStructure (class_ptr, typeof (GtkStyleContextClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkStyleContextClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
