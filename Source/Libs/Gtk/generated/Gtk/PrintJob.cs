...
#region Autogenerated code
	public partial class PrintJob : GLib.Object {
		...
		{
			GtkPrintJobClass class_iface = GetClassStruct (gtype, false);
		...
		{
			try {
				PrintJob __obj = GLib.Object.GetObject (inst, false) as PrintJob;
		...
		static Dictionary<GLib.GType, GtkPrintJobClass> class_structs;

		static GtkPrintJobClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkPrintJobClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkPrintJobClass class_struct = (GtkPrintJobClass) Marshal.PtrToStructure (class_ptr, typeof (GtkPrintJobClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkPrintJobClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
