...
#region Autogenerated code
	public partial class ApplicationWindow : Gtk.Window, GLib.IActionGroup, GLib.IActionMap {
		...
		static Dictionary<GLib.GType, GtkApplicationWindowClass> class_structs;

		static GtkApplicationWindowClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkApplicationWindowClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkApplicationWindowClass class_struct = (GtkApplicationWindowClass) Marshal.PtrToStructure (class_ptr, typeof (GtkApplicationWindowClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkApplicationWindowClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
