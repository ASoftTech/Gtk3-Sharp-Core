...
#region Autogenerated code
	public partial class TreeViewColumn : GLib.InitiallyUnowned, Gtk.ICellLayout {
		...
		{
			GtkTreeViewColumnClass class_iface = GetClassStruct (gtype, false);
		...
		static Dictionary<GLib.GType, GtkTreeViewColumnClass> class_structs;

		static GtkTreeViewColumnClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkTreeViewColumnClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkTreeViewColumnClass class_struct = (GtkTreeViewColumnClass) Marshal.PtrToStructure (class_ptr, typeof (GtkTreeViewColumnClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkTreeViewColumnClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
