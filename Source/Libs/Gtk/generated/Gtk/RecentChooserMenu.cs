...
#region Autogenerated code
	public partial class RecentChooserMenu : Gtk.Menu, Gtk.IRecentChooser, Gtk.IActivatable {
		...
		static uint class_offset = ((GLib.GType) typeof (Gtk.Menu)).GetClassSize ();
		static Dictionary<GLib.GType, GtkRecentChooserMenuClass> class_structs;

		static GtkRecentChooserMenuClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GtkRecentChooserMenuClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GtkRecentChooserMenuClass class_struct = (GtkRecentChooserMenuClass) Marshal.PtrToStructure (class_ptr, typeof (GtkRecentChooserMenuClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GtkRecentChooserMenuClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
