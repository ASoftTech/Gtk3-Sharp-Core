...
#region Autogenerated code
	public partial class Window : Gtk.Bin {
		...
		{
			GtkWindowClass class_iface = GetClassStruct (gtype, false);
			class_iface.EnableDebugging = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			EnableDebuggingNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).EnableDebugging;
		...
		struct GtkWindowClass {
			...
			public EnableDebuggingNativeDelegate EnableDebugging;
			IntPtr GtkReserved1;
			IntPtr GtkReserved2;
			IntPtr GtkReserved3;
		}
