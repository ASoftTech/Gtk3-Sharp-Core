...
#region Autogenerated code
	public partial class GLContext : GLib.Object {
		...
		{
			GdkGLContextClass class_iface = GetClassStruct (gtype, false);
		...
		{
			EndFrameNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).EndFrame;
		...
		{
			GdkGLContextClass class_iface = GetClassStruct (gtype, false);
			class_iface.TextureFromSurface = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			TextureFromSurfaceNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).TextureFromSurface;
		...
		struct GdkGLContextClass {
			...
			public EndFrameNativeDelegate EndFrame;
			public TextureFromSurfaceNativeDelegate TextureFromSurface;
		}

		static uint class_offset = ((GLib.GType) typeof (GLib.Object)).GetClassSize ();
		static Dictionary<GLib.GType, GdkGLContextClass> class_structs;

		static GdkGLContextClass GetClassStruct (GLib.GType gtype, bool use_cache)
		{
			if (class_structs == null)
				class_structs = new Dictionary<GLib.GType, GdkGLContextClass> ();

			if (use_cache && class_structs.ContainsKey (gtype))
				return class_structs [gtype];
			else {
				IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
				GdkGLContextClass class_struct = (GdkGLContextClass) Marshal.PtrToStructure (class_ptr, typeof (GdkGLContextClass));
				if (use_cache)
		...
		static void OverrideClassStruct (GLib.GType gtype, GdkGLContextClass class_struct)
		{
			IntPtr class_ptr = new IntPtr (gtype.GetClassPtr ().ToInt64 () + class_offset);
