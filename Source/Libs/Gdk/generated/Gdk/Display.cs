...
#region Autogenerated code
	public partial class Display : GLib.Object {
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.MakeDefault = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			MakeDefaultNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).MakeDefault;
			if (unmanaged == null) return;
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetCursorForSurface = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetCursorForSurfaceNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetCursorForSurface;
			if (unmanaged == null) return null;
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.MakeGlContextCurrent = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			MakeGlContextCurrentNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).MakeGlContextCurrent;
			if (unmanaged == null) return false;
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetDefaultSeat = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetDefaultSeatNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetDefaultSeat;
			if (unmanaged == null) return null;
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetMonitor = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetMonitorNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetMonitor;
			if (unmanaged == null) return null;
		...
		{
			GdkDisplayClass class_iface = GetClassStruct (gtype, false);
			class_iface.GetMonitorAtWindow = callback;
			OverrideClassStruct (gtype, class_iface);
		}
		...
		{
			GetMonitorAtWindowNativeDelegate unmanaged = GetClassStruct (this.LookupGType ().GetThresholdType (), true).GetMonitorAtWindow;
			if (unmanaged == null) return null;
		...
		struct GdkDisplayClass {
			...
			public MakeDefaultNativeDelegate MakeDefault;
			...
			public GetCursorForSurfaceNativeDelegate GetCursorForSurface;
			...
			public MakeGlContextCurrentNativeDelegate MakeGlContextCurrent;
			public GetDefaultSeatNativeDelegate GetDefaultSeat;
			public GetNMonitorsNativeDelegate GetNMonitors;
			public GetMonitorNativeDelegate GetMonitor;
			public GetPrimaryMonitorNativeDelegate GetPrimaryMonitor;
			public GetMonitorAtWindowNativeDelegate GetMonitorAtWindow;
